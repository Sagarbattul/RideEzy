...
const DriverPagiTran = () => {
  ...
  React.useEffect(() => {
    myAxios({
      url: `/api/drivers/getAllDriversByCityAndCategoryWithPagination/city/${data.city}/category/7?pageNumber=${pageNo}&pageSize=5&sortBy=id&sortDir=asc`,
    }).then((res) => {
